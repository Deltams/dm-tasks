...
for i in range(10):
    ...
    print(f'Функция сохраняющая ноль? {check_t0(vec)}')
    print(f'Функция сохраняющая единицу? {check_t1(vec)}')
    print(f'Функция является самодвойственной? {check_s(vec)}')
    print(f'Функция является линейной? {check_ln(vec)}')
    print(f'Функция является монотонной? {check_m(vec)}')
    print()
